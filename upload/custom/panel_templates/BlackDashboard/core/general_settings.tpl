    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">{$GENERAL_SETTINGS}</h3>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <a class="btn btn-default btn-sm" data-toggle="tooltip" title="{$INSTALL_LANGUAGE}" href="{$INSTALL_LANGUAGE_LINK}">
                                                    <i class="fas fa-plus-circle"></i>
                                                </a>
                                                <a class="btn btn-default btn-sm" data-toggle="tooltip" title="{$UPDATE_USER_LANGUAGES}" onclick="showLanguageModal()">

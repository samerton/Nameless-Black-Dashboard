    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">{$PANEL_TEMPLATES}</h3>

                        <a class="btn btn-info" href="{$INSTALL_TEMPLATE_LINK}">{$INSTALL_TEMPLATE}</a>
                        <hr />
                                        ...
                                        <td>
                                            <div class="float-md-right">
                                                {if $template.enabled}
                                                    ...
                                                    {else}
                                                        <a class="btn btn-info btn-sm" href="{$template.default_link}">{$MAKE_DEFAULT}</a>
                                                    {/if}
                                                {else}
                        ...
                        <a href="{$VIEW_ALL_TEMPLATES_LINK}" class="btn btn-info" target="_blank">{$VIEW_ALL_TEMPLATES} &raquo;</a>

...
if(!class_exists('BlackDashboard_Panel_Template')){
	class BlackDashboard_Panel_Template extends TemplateBase {
		...
		public function __construct($cache, $smarty, $language, $user, $pages){
			...
			$this->addCSSFiles(array(
				...
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/BlackDashboard/assets/css/black-dashboard.min.css' => array(),
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/BlackDashboard/assets/css/custom.css' => array(),
			));

			$this->addJSFiles(array(
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/BlackDashboard/assets/plugins/jquery/jquery.min.js' => array(),
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/core/assets/js/jquery.cookie.js' => array(),
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/BlackDashboard/assets/js/core/popper.min.js' => array(),
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/BlackDashboard/assets/js/core/bootstrap.min.js' => array(),
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/BlackDashboard/assets/js/black-dashboard.min.js' => array()
			));
...
$template = new BlackDashboard_Panel_Template($cache, $smarty, $language, $user, $pages);
